...
# Input fields
link = st.text_input("Enter the document link")
...
if st.button("Get Answer"):
    if link and question:
        with st.spinner('Processing...'):
            ...
            # Initialize chain for conversational retrieval
        ...
        st.error("Please provide both a link and a question.")
